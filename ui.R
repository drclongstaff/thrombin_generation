  ...
  sidebarLayout(                                      
    ...
    sidebarPanel( 
      ...
      fluidRow(
        ...
        column(4, radioButtons(inputId="Transf", label = "Correction method", 
    ...
    mainPanel( 
      ...
      tabPanel("Raw Data",
               ...
               radioButtons("whatRaw", label = NULL,
      ...
      tabPanel("Help",
               ...
               tags$blockquote(h5 ("►Calibrator tab",
                                   ...
                                   helpText(h5("Jackson, J et al, Sources of bias and limitations of thrombinography: inner filter effect
                                               and substrate depletion at the edge of failure algorithm, Thrombosis Journal, 21: 104, 2023",
                                               tags$a(href="https://thrombosisjournal.biomedcentral.com/articles/10.1186/s12959-023-00549-5",
                                                      "doi.org/10.1186/s12959-023-00549-5"))),
                                   
                                   tags$i("Please contact me with problems or suggestions relating to:"),
                                   helpText(h5("Thrombin generation assays app", Thisversion, " last accessed", Sys.Date(), "at",
